 ...
 */
class SlideEditorItem extends React.Component {
...
const DndSlideEditorItem = DragSource('SlideEditorItem', dragSource, dragSourceMapping)(SlideEditorItem)

export default DndSlideEditorItem